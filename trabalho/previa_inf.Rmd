...
Como resultado temos que com $\beta_0$ = `r b0`, $\beta_1$ = `r b1`, temos uma verossimilhança = `r vero`.
...
$\beta_0$ e $\beta_1$ simulados = `r b0` e`r b1`, já os estimados = `r oo$par[1]` e `r oo$par[2]`.

A verossimilhança simulada = `r vero` e a estimada = `r oo$value`.
